...
public class StreamFilter {
    ...
    public StreamFilter() {
        this(PersonFactory.getInstance().createPersonStream(100), StringUtils.capitalizeFirstChar(RandomUtils.createString('A', 'Z', 1)).charAt(0));
    }
    ...
    public List<Person> toListMultiLine() {
        return personStream.filter(person -> {
                                ...
                                return personName.startsWith(this.startingCharacter);})
